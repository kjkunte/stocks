...
# Calculate frequency (time delta) between two data points
time_delta = (prices.index[1] - prices.index[0]).days
print(f"Time Delta (Frequency) between data points: {time_delta} days")
...
simulated_data.to_excel("simulated_paths.xlsx")
